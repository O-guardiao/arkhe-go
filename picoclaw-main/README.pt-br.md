...
Alternativamente, baixe o binário para sua plataforma na página de [GitHub Releases](https://github.com/O-guardiao/arkhe-go/releases).
...
Para uma visão completa da arquitetura, mapa de pacotes, fluxos de runtime, build, testes, release e orientação para clean room design, consulte [docs/pt-br/documentacao-completa-do-repositorio.md](docs/pt-br/documentacao-completa-do-repositorio.md).
Para a leitura detalhada por área, com inventário estrutural, runtime core, integrações, launchers e guia de revisão clean room, consulte também [docs/pt-br/analise-clean-room/README.md](docs/pt-br/analise-clean-room/README.md).
