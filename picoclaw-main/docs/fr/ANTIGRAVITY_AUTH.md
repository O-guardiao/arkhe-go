...
**Important :** Ne validez pas de vraies credentiels OAuth. Chargez-les depuis des variables d'environnement :
...
if (!CLIENT_ID || !CLIENT_SECRET) {
  throw new Error(
    "Set PICOCLAW_ANTIGRAVITY_CLIENT_ID and PICOCLAW_ANTIGRAVITY_CLIENT_SECRET before enabling Antigravity OAuth."
  );
}
```
