...
type Config struct {
	...
	Recursion RecursionConfig `json:"recursion,omitempty" yaml:"-"`
...
// codex-cli, github-copilot, local rlm/rlm-local, and named OpenAI-compatible
// protocols such as groq, deepseek, modelscope, and novita.
